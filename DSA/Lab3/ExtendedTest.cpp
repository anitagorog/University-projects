...
void testLastIndex()
{
    cout << "Test LastIndex" << endl;
    IndexedList list1;
    assert(list1.lastIndexOf(2) == -1);
    list1.addToEnd(2);
    assert(list1.lastIndexOf(2) != -1);
    assert(list1.lastIndexOf(5) == -1);
    assert(list1.lastIndexOf(2) == 0);
    list1.addToEnd(3);
    list1.addToEnd(2);
    assert(list1.lastIndexOf(2) == 2);
    list1.remove(2);
    assert(list1.lastIndexOf(2) == 0);
    list1.addToPosition(0, 5);
    assert(list1.lastIndexOf(5) == 0);
}
